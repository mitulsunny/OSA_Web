           ...
           // $sql = "SELECT * FROM Questions where topic='$options' ORDER BY position_order";
            ...
            ?>
                <tr class="tableEven"  id="<?php echo $user['QuestionId'] ?>">
                    ...
                    <td>
                       <?php  echo 'id :<br><input type="text" readonly="readonly" style="font-size: 12pt" id="QuestionId'.$user['QuestionId'].'" value="'.$user['QuestionId'].'">';?>
                    ...
                    <br><?php echo $user['position_order'] ?>
                    <br><button type="submit" id="<?php echo "update".$user['QuestionId'];?>">UPDATE</button></td>
                    <script>
