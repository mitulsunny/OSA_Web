...
<table class="table table-striped">
 ...
 <script type="text/javascript">
  $(document).ready(function(){
   var url = 'agile_interview_question_database_help.php';
      $.getJSON(url, function(data) {
          $.each(data, function(index, data) {
           $('#tablebody').append('<tr>');
       $('#tablebody').append('<td>'+data.question+'</td>');
       $('#tablebody').append('<td>'+data.answer+'</td>');
       $('#tablebody').append('<td>'+data.topic+'</td>');
       $('#tablebody').append('<td>'+data.note+'</td>');
       $('#tablebody').append('</tr>');
    });
