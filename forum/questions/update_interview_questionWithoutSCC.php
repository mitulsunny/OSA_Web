...
while($row=mysqli_fetch_assoc($result)){
           echo 'id :<br><input type="text" id="QuestionId'.$row['QuestionId'].'" value="'.$row['QuestionId'].'">';?> <br><?php
     echo 'Question:<br><input type="text" id="question'.$row['QuestionId'].'" size="100" value="'.$row['question'].'">';?> <br><?php
  echo  'Answer:<br><textarea type="text" cols="100" rows="10" id="answer'.$row['QuestionId'].'" size="100"> '.$row['answer'].''; echo '</textarea>' ?><br><?php
 echo 'Topic:<br><input type="text" id="topic'.$row['QuestionId'].'" size="50" value="'.$row['topic'].'">';?> <br>
           <button type="submit" id="<?php echo "update".$row['QuestionId'];?>">UPDATE</button>
          <hr>
