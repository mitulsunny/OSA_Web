...
<div class="firstPart templete clear">
	<img class="logo" src="logo.png">
        ...
        <div class="sub">Behavioral Questions</div>
...
<div class="secondPart templete clear">
            <div class="leftColum">
                ...
                <li><a class="select" href="behavioral_interview_question.php">Behavioral</a></li>
...
$sql = "SELECT question, answer, note, topic ,position_order from Questions order by position_order asc";
